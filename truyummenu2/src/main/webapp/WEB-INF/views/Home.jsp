     ...
     <div class="topnav" id="myTopnav">
           ...
           <nav>
            <li> <a class="abc" href="menu-item-list.html">Menu Items</a></li> 
               <li><a class="abc" href="/login">Login</a></li>
              <li><a class="abc" href="/cart?id=102">Cart</a></li>
...
<div class="responsive">
    <div class="gallery">
      <a target="_blank" href="#">
        <img src= "${list.url}" alt="${list.name}" width="600" height="400">
      </a>
        <div class="desc">
            ...
            <div class="cardname1">
             ...
             <br>
            <div class="addcart">
             <a href="/cart?id=${list.id}" class="cart" ><i class="fas fa-cart-plus">Add to cart</i></a>
            </div>
