...
public String editMovieItem() {  

return "editmovie";  

}  
  
@RequestMapping(value="/editmovielist") 

public String editlist(ModelMap model, @RequestParam("id") int id, @RequestParam("title") String title, @RequestParam("active") String active, @RequestParam("boxOffice") String boxOffice, @RequestParam("dateOfLaunch") String dateOfLaunch, @RequestParam("genre") String genre, @RequestParam("hasTeaser") String hasTeaser) { 

String ed = login.edit(id,title,active,boxOffice,dateOfLaunch,genre,hasTeaser); 
